...
def upgrade() -> None:
    ...
    op.create_check_constraint(
        "ck_page_extraction_confidence_range",
        "page",
    ...
    op.create_table(
        ...
        sa.CheckConstraint("page_number >= 1", name="ck_document_table_page_number_positive"),
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint("ck_page_extraction_confidence_range", "page", type_="check")
